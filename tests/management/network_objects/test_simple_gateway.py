...
def test_add_simple_gateway(
    management, resp_simple_gateway_ipv4, resp_simple_gateway_ipv6
):
    ...
    resp = management.network_objects.simple_gateway.add(
        name="gw1",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.simple_gateway.add(name="gw1")


@responses.activate
def test_show_simple_gateway(management, resp_simple_gateway_ipv4):
    ...
    resp = management.network_objects.simple_gateway.show(
...
def test_set_simple_gateway(
    ...
    resp = management.network_objects.simple_gateway.set(
        uid="99457705-dc26-40ce-b9cd-5633eb09b1aa",
        new_name="gw1",
        ip_address="192.0.2.1",
        anti_bot=True,
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.simple_gateway.set()


@responses.activate
def test_delete_simple_gateway(management, resp_message_ok):
    ...
    resp = management.network_objects.simple_gateway.delete(
        uid="99457705-dc26-40ce-b9cd-5633eb09b1aa"
    )
...
@responses.activate
def test_show_simple_gateways(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.simple_gateway.show_simple_gateways()
