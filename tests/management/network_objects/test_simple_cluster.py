...
@responses.activate
def test_add_simple_cluster(management, resp_task):
    ...
    resp = management.network_objects.simple_cluster.add(
        name="cluster1",
...
def test_show_simple_cluster(
    management, resp_simple_cluster_ipv4, resp_simple_cluster_ipv6
):
    ...
    resp = management.network_objects.simple_cluster.show(
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.simple_cluster.add(name="cluster1")


@responses.activate
def test_set_simple_cluster(management, resp_task):
    ...
    resp = management.network_objects.simple_cluster.set(
        uid="4a5d882a-5568-2c3b-aa78-751ab23d6c11",
        new_name="cluster1",
        ip_address="17.23.5.1",
        anti_bot=True,
    ...
    # None arguments
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.simple_cluster.set()
...
@responses.activate
def test_delete_simple_cluster(management, resp_message_ok):
    ...
    resp = management.network_objects.simple_cluster.delete(
        uid="4a5d882a-5568-2c3b-aa78-751ab23d6c11"
    )
...
@responses.activate
def test_show_simple_clusters(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.simple_cluster.show_simple_clusters()
