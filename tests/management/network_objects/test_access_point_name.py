...
@responses.activate
def test_add_access_point_name(management, resp_access_point_name):
    ...
    resp = management.network_objects.access_point_name.add(
...
@responses.activate
def test_show_access_point_name(management, resp_access_point_name):
    ...
    resp = management.network_objects.access_point_name.show(
...
@responses.activate
def test_set_access_point_name(management, resp_access_point_name):
    ...
    resp = management.network_objects.access_point_name.set(
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.access_point_name.set()


@responses.activate
def test_delete_access_point_name(management, resp_message_ok):
    ...
    resp = management.network_objects.access_point_name.delete(
        uid="5064644d-6cc7-4703-823c-54f01ab720e6"
    )
...
@responses.activate
def test_show_access_point_names(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.access_point_name.show_access_point_names()
