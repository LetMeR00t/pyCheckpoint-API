...
@responses.activate
def test_add_dynamic_object(management, resp_dynamic_object):
    ...
    resp = management.network_objects.dynamic_object.add(
...
@responses.activate
def test_show_dynamic_object(management, resp_dynamic_object):
    ...
    resp = management.network_objects.dynamic_object.show(
...
@responses.activate
def test_set_dynamic_object(management, resp_dynamic_object):
    ...
    resp = management.network_objects.dynamic_object.set(
        uid="c5a7f50c-a951-45be-8b82-48441c9f48de",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.dynamic_object.set()


@responses.activate
def test_delete_dynamic_object(management, resp_message_ok):
    ...
    resp = management.network_objects.dynamic_object.delete(
        uid="c5a7f50c-a951-45be-8b82-48441c9f48de"
    )
...
@responses.activate
def test_show_dynamic_objects(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.dynamic_object.show_dynamic_objects()
