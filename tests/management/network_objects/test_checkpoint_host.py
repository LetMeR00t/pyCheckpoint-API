...
def test_add_checkpoint_host(
    management, resp_checkpoint_host_ipv4, resp_checkpoint_host_ipv6
):
    ...
    resp = management.network_objects.checkpoint_host.add(
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.checkpoint_host.add(name="secondarylogserver")


@responses.activate
def test_show_checkpoint_host(management, resp_checkpoint_host_ipv4):
    ...
    resp = management.network_objects.checkpoint_host.show(
...
def test_set_checkpoint_host(
    ...
    resp = management.network_objects.checkpoint_host.set(
        uid="f50f3810-d16c-4239-88d0-9f37ac581387",
        ip_address="5.5.5.5",
    ...
    # None arguments
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.checkpoint_host.set()


@responses.activate
def test_delete_checkpoint_host(management, resp_message_ok):
    ...
    resp = management.network_objects.checkpoint_host.delete(
...
@responses.activate
def test_show_checkpoint_hosts(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.checkpoint_host.show_checkpoint_hosts()
