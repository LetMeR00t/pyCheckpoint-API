...
@responses.activate
def test_add_time_group(management, resp_time_group):
    ...
    resp = management.network_objects.time_group.add(
...
@responses.activate
def test_show_time_group(management, resp_time_group):
    ...
    resp = management.network_objects.time_group.show(
...
@responses.activate
def test_set_time_group(management, resp_time_group):
    ...
    resp = management.network_objects.time_group.set(
        uid="d5878541-abbd-ad58-d23a-01a12352abc6",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.time_group.set()


@responses.activate
def test_delete_time_group(management, resp_message_ok):
    ...
    resp = management.network_objects.time_group.delete(
        uid="d5878541-abbd-ad58-d23a-01a12352abc6"
    )
...
@responses.activate
def test_show_time_groups(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.time_group.show_time_groups()
