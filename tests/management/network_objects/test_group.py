...
@responses.activate
def test_add_group(management, resp_group):
    ...
    resp = management.network_objects.group.add(
...
@responses.activate
def test_show_group(management, resp_group):
    ...
    resp = management.network_objects.group.show(
...
@responses.activate
def test_set_group(management, resp_group):
    ...
    resp = management.network_objects.group.set(
        uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.network_objects.group.set()


@responses.activate
def test_delete_group(management, resp_message_ok):
    ...
    resp = management.network_objects.group.delete(
        uid="ed997ff8-6709-4d71-a713-99bf01711cd5"
    )
...
@responses.activate
def test_show_groups(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.network_objects.group.show_groups()
