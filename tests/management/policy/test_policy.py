...
@responses.activate
def test_install_policy(management, resp_task):
    responses.add(
        responses.POST,
    ...
    resp = management.policy.install_policy(
...
@responses.activate
def test_verify_policy(management, resp_task):
    responses.add(
        responses.POST,
    ...
    resp = management.policy.verify_policy(policy_package="standard")
