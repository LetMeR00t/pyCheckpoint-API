...
@responses.activate
def test_add_application_site(management, resp_application_site):
    ...
    resp = management.service_applications.application_site.add(
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.application_site.add(
            name="New Application Site 1",
            primary_category="Anonymizer",
        )
...
@responses.activate
def test_show_application_site(management, resp_application_site):
    ...
    resp = management.service_applications.application_site.show(
...
@responses.activate
def test_set_application_site(management, resp_application_site):
    ...
    resp = management.service_applications.application_site.set(
        uid="ded526ad-5d62-a851-2523-d3ac26998ef3",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.application_site.set()


@responses.activate
def test_delete_application_site(management, resp_message_ok):
    ...
    resp = management.service_applications.application_site.delete(
        uid="ded526ad-5d62-a851-2523-d3ac26998ef3"
    )
...
def test_show_application_sites(management, resp_from_to_objects):
    ...
    resp = management.service_applications.application_site.show_application_sites()
