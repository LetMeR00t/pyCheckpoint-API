...
@responses.activate
def test_add_service_group(management, resp_service_group):
    ...
    resp = management.service_applications.service_group.add(
    ...
    with pytest.raises(TypeError):
        management.service_applications.service_group.add()


@responses.activate
def test_show_service_group(management, resp_service_group):
    ...
    resp = management.service_applications.service_group.show(
...
@responses.activate
def test_set_service_group(management, resp_service_group):
    ...
    resp = management.service_applications.service_group.set(
        uid="dce67d0d-5efe-4808-b22d-2eb99e24c70d",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.service_group.set()


@responses.activate
def test_delete_service_group(management, resp_message_ok):
    ...
    resp = management.service_applications.service_group.delete(
        uid="dce67d0d-5efe-4808-b22d-2eb99e24c70d"
    )
...
@responses.activate
def test_show_service_groups(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.service_applications.service_group.show_service_groups()
