...
@responses.activate
def test_add_application_site_group(management, resp_application_site_group):
    ...
    resp = management.service_applications.application_site_group.add(
...
@responses.activate
def test_show_application_site_group(management, resp_application_site_group):
    ...
    resp = management.service_applications.application_site_group.show(
...
@responses.activate
def test_set_application_site_group(management, resp_application_site_group):
    ...
    resp = management.service_applications.application_site_group.set(
        uid="5a2d5c36-1998-2022-acce-a5c3b699d522",
...
@responses.activate
def test_delete_application_site_group(management, resp_message_ok):
    ...
    resp = management.service_applications.application_site_group.delete(
        uid="5a2d5c36-1998-2022-acce-a5c3b699d522"
    )
...
@responses.activate
def test_show_application_site_groups(management, resp_from_to_objects):
    responses.add(
        responses.POST,
