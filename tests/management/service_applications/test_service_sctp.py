...
@responses.activate
def test_add_service_sctp(management, resp_service_sctp):
    ...
    resp = management.service_applications.service_sctp.add(
...
@responses.activate
def test_show_service_sctp(management, resp_service_sctp):
    ...
    resp = management.service_applications.service_sctp.show(
...
@responses.activate
def test_set_service_sctp(management, resp_service_sctp):
    ...
    resp = management.service_applications.service_sctp.set(
        uid="d0385c6d-72dd-4981-b951-4783b7100343",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.service_sctp.set()


@responses.activate
def test_delete_service_sctp(management, resp_message_ok):
    ...
    resp = management.service_applications.service_sctp.delete(
        uid="d0385c6d-72dd-4981-b951-4783b7100343"
    )
...
@responses.activate
def test_show_services_sctp(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.service_applications.service_sctp.show_services_sctp()
