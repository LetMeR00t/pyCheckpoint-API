...
@responses.activate
def test_add_service_udp(management, resp_service_udp):
    ...
    resp = management.service_applications.service_udp.add(
...
@responses.activate
def test_show_service_udp(management, resp_service_udp):
    ...
    resp = management.service_applications.service_udp.show(
...
@responses.activate
def test_set_service_udp(management, resp_service_udp):
    ...
    resp = management.service_applications.service_udp.set(
        uid="64a4c8d1-7fed-4320-9826-0570bbb4a5bd",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.service_udp.set()


@responses.activate
def test_delete_service_udp(management, resp_message_ok):
    ...
    resp = management.service_applications.service_udp.delete(
        uid="64a4c8d1-7fed-4320-9826-0570bbb4a5bd"
    )
...
@responses.activate
def test_show_services_udp(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.service_applications.service_udp.show_services_udp()
