...
@responses.activate
def test_add_service_icmp6(management, resp_service_icmp6):
    ...
    resp = management.service_applications.service_icmp6.add(
        name="Icmp2",
        port=5669,
...
@responses.activate
def test_show_service_icmp6(management, resp_service_icmp6):
    ...
    resp = management.service_applications.service_icmp6.show(
...
@responses.activate
def test_set_service_icmp6(management, resp_service_icmp6):
    ...
    resp = management.service_applications.service_icmp6.set(
        uid="d9dcb753-1aa7-4e65-b5ff-b4878f8b3890",
        new_name="Icmp2",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.service_icmp6.set()


@responses.activate
def test_delete_service_icmp6(management, resp_message_ok):
    ...
    resp = management.service_applications.service_icmp6.delete(
        uid="d9dcb753-1aa7-4e65-b5ff-b4878f8b3890"
    )
...
@responses.activate
def test_show_services_icmp6(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.service_applications.service_icmp6.show_services_icmp6()
