...
@responses.activate
def test_add_service_gtp(management, resp_service_gtp):
    ...
    resp = management.service_applications.service_gtp.add(
...
@responses.activate
def test_show_service_gtp(management, resp_service_gtp):
    ...
    resp = management.service_applications.service_gtp.show(
...
@responses.activate
def test_set_service_gtp(management, resp_service_gtp):
    ...
    resp = management.service_applications.service_gtp.set(
        uid="70e390d7-b070-4d6e-b8d7-53b7f6cc7fe6",
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.service_applications.service_gtp.set()


@responses.activate
def test_delete_service_gtp(management, resp_message_ok):
    ...
    resp = management.service_applications.service_gtp.delete(
        uid="70e390d7-b070-4d6e-b8d7-53b7f6cc7fe6"
    )
...
@responses.activate
def test_show_services_gtp(management, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = management.service_applications.service_gtp.show_services_gtp()
