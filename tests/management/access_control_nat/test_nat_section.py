...
@responses.activate
def test_add_nat_section(management, resp_nat_section):
    ...
    resp = management.access_control_nat.nat_section.add(
        package="standard",
        position=1,
...
@responses.activate
def test_show_nat_section(management, resp_nat_section):
    ...
    resp = management.access_control_nat.nat_section.show(
    ...
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.nat_section.show(package="standard")


@responses.activate
def test_set_nat_section(management, resp_nat_section):
    ...
    resp = management.access_control_nat.nat_section.set(
        package="standard",
    ...
    # Missing mandatory parameter
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.nat_section.set(package="standard")


@responses.activate
def test_delete_nat_section(management, resp_message_ok):
    ...
    resp = management.access_control_nat.nat_section.delete(
    ...
    # Missing mandatory parameter
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.nat_section.delete(package="standard")
