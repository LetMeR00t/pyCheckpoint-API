...
@responses.activate
def test_add_access_rule(management, resp_access_rule):
    ...
    resp = management.access_control_nat.access_rule.add(
        layer="Network",
        position=1,
        name="Rule 1",
        action="Drop",
...
@responses.activate
def test_show_access_rule(management, resp_access_rule):
    ...
    resp = management.access_control_nat.access_rule.show(
    ...
    with pytest.raises(TypeError):
        management.access_control_nat.access_rule.show(rule_number=3)

    # Missing mandatory parameter
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.access_rule.show(layer="Network")


@responses.activate
def test_set_access_rule(management, resp_access_rule):
    ...
    resp = management.access_control_nat.access_rule.set(
        uid="1df8a4b0-fa8b-428b-b649-626b74bf7f81",
        new_name="Rule 1",
        new_position=3,
        layer="Network",
    ...
    # Missing mandatory parameter
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.access_rule.set(layer="Network")


@responses.activate
def test_delete_access_rule(management, resp_message_ok):
    ...
    resp = management.access_control_nat.access_rule.delete(
    ...
    # Missing mandatory parameter
    with pytest.raises(MandatoryFieldMissing):
        management.access_control_nat.access_rule.delete(layer="Network")


@responses.activate
def test_show_access_rulebase(management, resp_access_rulebase):
    responses.add(
        responses.POST,
