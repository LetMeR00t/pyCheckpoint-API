...
@responses.activate
def test_add_lsm_cluster(firewallManagement, resp_lsm_cluster):
...
@responses.activate
def test_show_lsm_cluster(firewallManagement, resp_lsm_cluster):
    ...
    resp = firewallManagement.network_objects.lsm_cluster.show(
...
@responses.activate
def test_set_lsm_cluster(firewallManagement, resp_lsm_cluster):
...
@responses.activate
def test_delete_lsm_cluster(firewallManagement, resp_message_ok):
    ...
    resp = firewallManagement.network_objects.lsm_cluster.delete(
        uid="d1c363bc-c4c6-4903-9426-495d800b47ae"
    )
...
@responses.activate
def test_show_lsm_clusters(firewallManagement, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = firewallManagement.network_objects.lsm_cluster.show_lsm_clusters()
