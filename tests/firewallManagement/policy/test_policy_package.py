...
@responses.activate
def test_add_policy_package(firewallManagement, resp_package):
    responses.add(
        responses.POST,
    ...
    resp = firewallManagement.policy.package.add(
...
@responses.activate
def test_show_policy_package(firewallManagement, resp_package):
    ...
    resp = firewallManagement.policy.package.show(
    ...
    resp = firewallManagement.policy.package.show(name="New Standard Package 1")
...
@responses.activate
def test_set_host(firewallManagement, resp_package):
    ...
    resp = firewallManagement.policy.package.set(
        uid="38b4ed6e-711c-49fa-b9f4-638290d621be",
...
@responses.activate
def test_delete_package(firewallManagement, resp_message_ok):
    ...
    resp = firewallManagement.policy.package.delete(
        uid="38b4ed6e-711c-49fa-b9f4-638290d621be"
    )

    assert resp.message == "OK"

    resp = firewallManagement.policy.package.delete(name="New Standard Package 1")
...
@responses.activate
def test_show_packages(firewallManagement, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = firewallManagement.policy.package.show_packages(
