...
@responses.activate
def test_add_service_icmp(firewallManagement, resp_service_icmp):
    ...
    resp = firewallManagement.service_applications.service_icmp.add(
        name="Icmp1",
        port=5669,
...
@responses.activate
def test_show_service_icmp(firewallManagement, resp_service_icmp):
    ...
    resp = firewallManagement.service_applications.service_icmp.show(
...
@responses.activate
def test_set_service_icmp(firewallManagement, resp_service_icmp):
...
@responses.activate
def test_delete_service_icmp(firewallManagement, resp_message_ok):
    ...
    resp = firewallManagement.service_applications.service_icmp.delete(
        uid="22c8faba-3a24-4e99-ae6f-e798014facc2"
    )
...
@responses.activate
def test_show_services_icmp(firewallManagement, resp_from_to_objects):
    responses.add(
        responses.POST,
    ...
    resp = firewallManagement.service_applications.service_icmp.show_services_icmp()
