...
@responses.activate
def test_add_application_site_category(
    firewallManagement, resp_application_site_category
):
    ...
    resp = firewallManagement.service_applications.application_site_category.add(
    ...
    with pytest.raises(TypeError):
        firewallManagement.service_applications.application_site_category.add()


@responses.activate
def test_show_application_site_category(
    firewallManagement, resp_application_site_category
):
    ...
    resp = firewallManagement.service_applications.application_site_category.show(
...
@responses.activate
def test_set_application_site_category(
    firewallManagement, resp_application_site_category
):
    ...
    resp = firewallManagement.service_applications.application_site_category.set(
        uid="aa85d95a-2548-2136-aa4a-cc8a95c26d8ad92",
    ...
    with pytest.raises(MandatoryFieldMissing):
        firewallManagement.service_applications.application_site_category.set()


@responses.activate
def test_delete_application_site_category(firewallManagement, resp_message_ok):
    ...
    resp = firewallManagement.service_applications.application_site_category.delete(
        uid="aa85d95a-2548-2136-aa4a-cc8a95c26d8ad92"
    )
...
def test_show_application_sites(firewallManagement, resp_from_to_objects):
    ...
    resp = (
        firewallManagement.service_applications.application_site_category.show_application_site_categories()
    )
