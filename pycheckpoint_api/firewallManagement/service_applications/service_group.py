...
class ServiceGroupAPI(NetworkObjectAPI):
    def add(
        ...
        **kw
        ...
        Examples:
            >>> firewallManagementApi.service_applications.service_group.add(name="My object")
        """
    ...
    def set(
        ...
        **kw
        ...
        Returns:
            :obj:`Box`: The response from the server
        Examples:
            >>> firewallManagement.service_applications.service_group.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
