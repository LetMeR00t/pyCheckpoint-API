...
class ServiceICMP6API(NetworkObjectAPI):
    def add(
        self,
        name: str,
        icmp6_code: int = 0,
    ...
    def show(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Returns:
            :obj:`Box`: The response from the server
        Examples:
            >>> firewallManagementApi.service_applications.service_icmp6.show(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Returns:
            :obj:`Box`: The response from the server
        Examples:
            >>> firewallManagementApi.service_applications.service_icmp6.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
    ...
    def show_services_icmp6(
        ...
        **kw
        ...
        Returns:
            :obj:`Box`: The response from the server
        Examples:
            >>> firewallManagementApi.service_applications.service_icmp6.shows_services_icmp6()
        """
