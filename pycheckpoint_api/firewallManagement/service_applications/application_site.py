    ...
    def add(
        ...
        **kw,
        ...
        Args:
            ...
            url_list (Union[str, List[str]]): URLs that determine this particular application. Mandatory if
            application_signature is not set.
            application_signature (Union[str, List[str]]): Application signature generated by Signature Tool. Mandatory if
            url_list is not set.
            additional_categories (Union[str, List[str]]): Used to configure or edit the additional categories of a custom
