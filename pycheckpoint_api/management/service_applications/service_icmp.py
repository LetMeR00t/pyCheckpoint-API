...
class ServiceICMP(NetworkObject):
    def add(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_icmp.add(
            ... name="Icmp1",
            ... port=5669,
    ...
    def show(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_icmp.show(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
    ...
    def set(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_icmp.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_icmp.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
