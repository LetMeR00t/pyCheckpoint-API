...
class ServiceTCP(NetworkObject):
    def add(
        self,
        name: str,
        ...
        **kw
        ...
        Args:
            ...
            signature - the signature identifies the protocol as genuine. Select this option to limit the port to \
            the specified protocol.\ If the selected protocol does not support matching by signature, this field \
            ...
            Numbers will be Accepted, Dropped, or Rejected during packet inspection. Otherwise, the source port is \
            not inspected.
        ...
        Examples:
            >>> management.service_applications.service_tcp.add(
    ...
    def show(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_tcp.show(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
    ...
    def set(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_tcp.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_tcp.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
