...
class ServiceSCTP(NetworkObject):
    def add(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_sctp.add(
    ...
    def show(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_sctp.show(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
    ...
    def set(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_sctp.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_sctp.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
