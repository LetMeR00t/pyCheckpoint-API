...
class ServiceICMP6(NetworkObject):
    def add(
        self,
        name: str,
        icmp6_code: int = 0,
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_icmp6.add(
            ... name="Icmp2",
            ... port=5669,
        ...
        if icmp6_code is not None:
            payload["icmp6-code"] = icmp6_code
        if icmp6_type is not None:
            payload["icmp6-type"] = icmp6_type
        ...
        return self._post("add-service-icmp6", json=payload)
    ...
    def show(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_icmp6.show(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
        return self.show_object(endpoint="show-service-icmp6", uid=uid, name=name, **kw)
    ...
    def set(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_icmp6.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
        ...
        return self._post("set-service-icmp6", json=payload)
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_icmp6.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
        return self.delete_object(
            endpoint="delete-service-icmp6", uid=uid, name=name, **kw
        )

    def show_services_icmp6(
        self,
