...
class ServiceRPC(NetworkObject):
    def add(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_rpc.add(
        ...
        if program_number is not None:
            payload["program-number"] = program_number
        ...
        return self._post("add-service-rpc", json=payload)
    ...
    def set(
        ...
        **kw
        ...
        Examples:
            >>> management.service_applications.service_rpc.set(uid="ed997ff8-6709-4d71-a713-99bf01711cd5",
        ...
        return self._post("set-service-rpc", json=payload)
    ...
    def delete(self, uid: str = None, name: str = None, **kw) -> Box:
        ...
        Examples:
            >>> Management.service_applications.service_rpc.delete(uid="ed997ff8-6709-4d71-a713-99bf01711cd5")
        """
        return self.delete_object(
            endpoint="delete-service-rpc", uid=uid, name=name, **kw
        )

    def show_services_rpc(
        self,
        ...
        **kw
        ...
        Examples:
            >>> Management.service_applications.service_rpc.show_services_rpc()
        """
